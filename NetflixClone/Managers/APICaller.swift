...
// popular
// https://api.themoviedb.org/3/movie/popular?api_key=***REMOVED-TMDB-KEY***&language=en-US&page=1

//top rated
//https://api.themoviedb.org/3/movie/top_rated?api_key=***REMOVED-TMDB-KEY***&language=en-US&page=1
